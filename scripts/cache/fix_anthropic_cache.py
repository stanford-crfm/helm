...
from helm.clients.anthropic_client import AnthropicLegacyPreviewClient
...
def make_logprobs_request_with_retry(
    client: AnthropicLegacyPreviewClient, text: str, top_k_per_token: int, model_engine: str
) -> Dict[str, List[str]]:
...
def add_logprobs(mongo_uri: str, credentials_path: str, dry_run: bool):
    ...
    client = AnthropicLegacyPreviewClient(api_key=api_key, cache_config=cache_config)
