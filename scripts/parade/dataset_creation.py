...
def create_final_annotation(
    ...
    """
    final_annot: Dict[str, Dict[str, Dict[str, Dict[str, Any]]]] = {char: {cat: {} for cat in CATEGORIES} for char in CHARACTERS}
        ...
        for key2 in CATEGORIES:
            for key3 in annot[key1][key2]:
                ...
                for key4 in annot[key1][key2][key3]:
                    ...
                    final_annot[key1][key2][key3][key4] = {"path": path, "question": question, 
