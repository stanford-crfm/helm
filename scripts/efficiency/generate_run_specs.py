...
def main(args):
    ...
    if args.tokenizer_provider == "ai21":
        ...
        all_models_and_tokenizers = [("together/t5-11b", "google/t5")]
        ...
        all_models_and_tokenizers = [("together/gpt-j-6b", "eleutherai/gptj")]
    elif args.tokenizer_provider == "gptneox":
        all_models_and_tokenizers = [("together/gpt-neox-20b", "eleutherai/gptneox")]
