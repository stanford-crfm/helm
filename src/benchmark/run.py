...
def main():
    ...
    parser.add_argument(
        "-a", "--api-key-path", type=str, default="crfm_benchmarking_api_key.txt", help="Path to API key",
    )
    ...
    execution_spec = ExecutionSpec(auth=Authentication(api_key=api_key), url=args.url, parallelism=args.num_threads)
