        ...
        for split in ALL_SPLITS:
            ...
            with open(abstract_path, "r") as abstract_file:
                with open(pls_path, "r") as pls_file:
                    for abstract_line, pls_line in zip(abstract_file, pls_file):
                        abstract: str = abstract_line.rstrip()
                        pls: str = pls_line.rstrip()
                        instance: Instance = Instance(
                            input=abstract, references=[Reference(output=pls, tags=[CORRECT_TAG])], split=split,
                        )
