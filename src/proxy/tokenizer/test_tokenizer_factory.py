...
class TestTokenizerFactory:
    def test_cache(self):
        ...
        tokenizer = TokenizerFactory.get_tokenizer(model_name_or_organization="huggingface/gpt2")
    ...
    def test_no_tokenizer_service_for_ai21(self):
        ...
        try:
            TokenizerFactory.get_tokenizer(model_name_or_organization="ai21/j1-large")
            assert False
