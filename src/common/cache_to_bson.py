...
from common.cache import get_all_sqlite_items
...
def dump_all_caches(cache_dir: str, bson_dir: str, dry_run: bool):
...
def dump_cache(
    ...
    bson_path = os.path.join(bson_dir, f"{organization}.bson.gz")
