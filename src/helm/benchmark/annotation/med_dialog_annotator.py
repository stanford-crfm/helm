...
Your goal is to assess how well the summary captures the patient-doctor conversation, and how it compares to the gold response in terms of accuracy, completeness, and clarity.
