...
class ArabicLegalAnnotator(Annotator):
    ...
    PROMPT_TEMPLATE = """Here is a legal question, a reference answer, and a model output, delineated with start and end tags. Judge whether the model output is equivalent to the reference answer.
