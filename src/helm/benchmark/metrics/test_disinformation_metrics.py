...
from helm.common.request import Completion, Token
...
_TEST_1 = Completion(text="This is a test", logprob=-1, tokens=_TEST_1_TOKENS)
_TEST_2 = Completion(text="This is another test", logprob=-1.25, tokens=_TEST_2_TOKENS)
_TEST_EMPTY = Completion(text="", logprob=-float("nan"), tokens=_TEST_EMPTY_TOKENS)
_TEST_EMPTY_STR = Completion(text="", logprob=0, tokens=test_empty_str_tokens)
