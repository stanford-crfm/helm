...
from helm.benchmark.metrics.metric import MetricInterface, MetricMetadata, MetricResult
    ...
    def get_metadata(self) -> List[MetricMetadata]:
        return [
            MetricMetadata(
                ...
                description="Fréchet Inception Distance (FID) is a metric used for evaluating the quality of images generated by models. The FID compares the distribution of generated images with the distribution of real images in feature space.",
                lower_is_better=True,
                group="heim_inception",
            ),
            MetricMetadata(
