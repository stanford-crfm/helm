...
class BasicMetric(Metric):
    ...
    def __init__(self, names: List[str]):
        ...
        self.general_helper = GeneralMetricsHelper()
    ...
    def evaluate_generation(
        ...
        """Compute all metrics."""
        stats: List[Stat] = []
        stats.extend(self.general_helper.compute_all_general_metrics(adapter_spec, request_state, metric_service))
...
class GeneralMetricsHelper:
    ...
    def compute_all_general_metrics(
        ...
        stats.extend(compute_finish_reason_metrics(adapter_spec, request_state, metric_service))
        stats.extend(compute_truncation_metrics(adapter_spec, request_state, metric_service))
