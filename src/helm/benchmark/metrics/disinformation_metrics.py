...
def _self_bleu(completions: List[Completion]) -> float:
    """Self-BLEU.
...
def _monte_carlo_entropy(completions: List[Completion]) -> float:
...
completion_metric_fns: Dict[str, Callable[[List[Completion]], float]] = {
