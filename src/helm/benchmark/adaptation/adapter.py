...
from helm.common.general import parallel_map, flatten_list
...
ADAPT_MULTIPLE_CHOICE_METHODS = [ADAPT_MULTIPLE_CHOICE_SEPARATE_ORIGINAL, ADAPT_MULTIPLE_CHOICE_SEPARATE_CALIBRATED]
