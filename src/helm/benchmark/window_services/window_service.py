...
class WindowService(ABC):
    ...
    def max_generated_max_tokens(self) -> int:
        """
        The max number of tokens that can be generated by the model.
        i.e. the maximum value of `max_tokens` in the request.
        Some models like anthropic/claude-v1.3-100k have no sequence length limit
        but have a max token limit. Most models have no max token limit.
        """
        return INT_MAX
