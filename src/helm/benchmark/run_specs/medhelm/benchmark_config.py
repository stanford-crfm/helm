...
from helm.benchmark.metrics.common_metric_specs import get_basic_metric_specs, get_exact_match_metric_specs, get_f1_metric_specs, get_language_modeling_metric_specs, get_classification_metric_specs   
    ...
    def get_metric_specs(self) -> List[MetricSpec]:
        ...
        for metric in self.metrics:
            if metric.name == "exact_match":
                ...
                annotator_models = {
                    judge.model_deployment: judge 
                    for judge in metric.judges
                }
                
                metric_specs.extend(MetricSpec(
    ...
    def get_annotator_specs(self) -> List[AnnotatorSpec]:
        ...
        for metric in self.metrics:
            if isinstance(metric, JuryMetricConfig):
                ...
                annotator_specs.append(AnnotatorSpec(
