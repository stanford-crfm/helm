...
def get_medhallu_spec() -> RunSpec:
    ...
    adapter_spec = get_generation_adapter_spec(
        instructions=(
            ...
            "Given a question and an answer, your objective is to determine if the provided answer contains"
            ...
            "You are trying to determine if there is a factual contradiction between the answer and the world"
            "knowledge. Some information in the answer might be fabricated. Answer '0' if the answer is factual"
            "and '1' if the answer is hallucinated."
            "You can categorize the answer as hallucinated if it falls in either of the category:"
            "Type: Misinterpretation of #Question#: These are hallucinated answers that misunderstands the question,"
            "leading to an off-topic or irrelevant response."
            "Type: Incomplete Information: These are hallucinated answers that Point out what is not true without"
            "providing correct information."
            "Type: Mechanism and Pathway Misattribution -"
            "These are hallucinated answer that falsely attribution of biological mechanisms,"
            "molecular pathways, or disease processes that contradicts established medical knowledge"
            "Type: Methodological and Evidence Fabrication -"
            "Inventing false research methods, statistical data, or specific clinical outcomes"
        ),
        input_noun=None,
        output_noun=(
