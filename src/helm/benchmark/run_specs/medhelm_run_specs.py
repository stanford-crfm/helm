...
def get_ehr_sql_run_spec() -> RunSpec:
    ...
    adapter_spec = get_generation_adapter_spec(
        instructions=(
            ...
            "Output: A valid SQL query ending with ;. Only return SQL query, don't add additional text. If the question is unanswerable, return an empty string without additional text or comments."
        ),
