...
class TestCustomQAScenario(Scenario):
    ...
    DATASET_FILE_NAME: str = "test_custom_qa.csv"
    ...
    def download_dataset(self, output_path, dataset_path="datasets/processed_data/test"):
    ...
    def load_dataset(self, output_path: str) -> List[Dict[str, Any]]:
        ...
        with open(file_path, encoding="utf-8") as f:
            ...
            for _ind, _type, category, question, best_answer, correct_answers, incorrect_answers, source in csv_reader:
                data_point = {
                    "category": category,
                    "question": question,
