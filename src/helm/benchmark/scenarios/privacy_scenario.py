            ...
            for pii in PII_INFO:
                ...
                for fewshot_type in PII_PROMPT_TYPE:
                    dataset, gt_list = get_pii_messages_k_shot(
                        filename=data_file, k=few_shot_num, pp=pii, fewshot_type=fewshot_type, num_cases=dataset_size
                    )
...
def get_privacy_understanding_messages(
    ...
    for prompt in prompts:
        ...
        messages.append([{"role": "user", "content": f"{secret}\n {question}"}])
