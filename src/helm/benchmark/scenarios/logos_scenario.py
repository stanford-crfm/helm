...
class LogosScenario(Scenario):
    ...
    of Fortune 100 companies for the year 2022. Set `medium` to "logo" in the `AdapterSpec`, which will
    produce prompts in the following format: "a logo of <company description>".
    """
