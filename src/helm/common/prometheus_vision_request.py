...
class PrometheusVisionOutput:
    ...
    def __add__(self, other: "PrometheusVisionOutput") -> "PrometheusVisionOutput":
        return PrometheusVisionOutput(
            self.score + other.score, self.logprob + other.logprob, self.tokens + other.tokens
        )
...
class PrometheusVisionRequestResult:
    """What comes back due to a `Request`."""

    success: bool
    """Whether the request was successful"""

    scores: List[PrometheusVisionOutput]
    """List of scores"""
