...
function ReleaseDropdown() {
  ...
  // Temporarily disable the version dropdown for the Lite release because it only has one verison.
  // TODO(#2146): Enable the version dropdown.
  const enableDropdown = false;
  if (enableDropdown) {
    return (
      <div>
    ...
    return <div className="inline-flex items-center">Release: {release}</div>;
  }
}
